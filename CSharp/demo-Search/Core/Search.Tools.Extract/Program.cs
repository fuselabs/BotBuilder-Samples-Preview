...
#else
                    string jsonHistograms = JsonConvert.SerializeObject(histograms);
                    stream.Write(UnicodeEncoding.UTF8.GetBytes(jsonHistograms), 0, UnicodeEncoding.UTF8.GetByteCount(jsonHistograms));
#endif
                }
